...
[![GoDoc](https://godoc.org/github.com/LewisWatson/api2go?status.svg)](https://godoc.org/github.com/LewisWatson/api2go)
...
```go
go get github.com/LewisWatson/api2go
```
...
- Basic Examples can be found [here](https://github.com/LewisWatson/api2go/blob/master/examples/crud_example.go).
...
can directly use our sub-package `github.com/LewisWatson/api2go/jsonapi` 
...
```go get -tags=gingonic github.com/LewisWatson/api2go```
